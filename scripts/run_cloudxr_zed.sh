...
QUEST_WAIT_SECONDS="${QUEST_WAIT_SECONDS:-300}"
...
echo "Open https://<PC-LAN-IP>:48322/client/ in Quest Browser, then CONNECT."
echo "Waiting up to $QUEST_WAIT_SECONDS seconds for the Quest CloudXR connection..."
quest_connected=false
for ((second = 0; second < QUEST_WAIT_SECONDS; second += 1)); do
